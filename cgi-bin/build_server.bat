...
g++ -o webworld_server.exe accounting_line.o accounting_journal.o accounting_general_ledger.o accounting_entry.o accounting_date.o accounting_book.o accounting_account_type.o accounting_account.o web_com.o main_server.o 